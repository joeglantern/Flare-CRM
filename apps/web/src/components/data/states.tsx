/**
 * EmptyState, ErrorState, ForbiddenState and OfflineState (Component Inventory · Data display).
 * Each names what is missing rather than offering a generic apology. ForbiddenState always names
 * the permission, which is what makes it actionable.
 */
...
export type ViewState = 'loading' | 'ready' | 'empty' | 'error' | 'forbidden' | 'offline';
