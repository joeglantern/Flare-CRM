  ...
  return (
    ...
    >
      {stage === 'password' ? (
        ...
        >
          <div>
            <h2 className="text-base font-medium">1. Add this to your authenticator app</h2>
            <p className="mt-1 text-sm text-muted">
              Google Authenticator, 1Password, Authy and Microsoft Authenticator all work.
            </p>
            {uri !== null && (
              <code className="mono mt-2 block break-all rounded-sm border border-border bg-surface p-2 text-xs">
                {uri}
              </code>
            )}
          </div>
