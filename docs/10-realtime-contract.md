...
| `system:announce`                           | `all`                                                            | `{ level, message }` — also raised by an announcement from the owner console (docs/21)                                                                                                                                                                                                                                                                                 |
| `entitlements:changed`                      | `all`                                                            | `{ plan, features, expiresAt, issueId }` — a new signed document was applied (docs/20)                                                                                                                                                                                                                                                                                 |
